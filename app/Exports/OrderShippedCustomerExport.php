...
class OrderShippedCustomerExport implements FromView
{
    private $data;
    ...
    public function view(): View
    {
        ...
        //     JOIN sizes on perfoma_invoice_details.size_id = sizes.id where invoice_creations.awb_date IS NOT NULL AND customers.id = {$id}");
        //     // dd($data);
        $data = $this->data;
