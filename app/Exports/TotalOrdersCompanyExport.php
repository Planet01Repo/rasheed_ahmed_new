...
class TotalOrdersCompanyExport implements FromView
{
    private $data;
    ...
    public function view(): View
    {
        ...
        //     join companies on customers.company_id = companies.id where customers.company_id = {$id}");
        //     // dd($data);
        $data = $this->data;
