            ...
            <div class="span12">
              <div class="grid simple ">
                ...
                <div class="grid-title">
                  ...
                  <a style="float: right;" class="btn btn-success btn-cons" href="{{route('po_material.add')}}">Add</a>
                  ...
                  <table class="table" id="example3" >
                    ...
                    @php ($count = 1)
                      ...
                      <tr class="">
                        ...
                        <td>
                          <a href="{{route('po_material.add')}}/{{$v['id']}}" class="btn-warning btn btn-sm" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
