...
<body>
  ...
  <div class="border" style="padding-left:10px;border-top:none;margin-top:-12px">
    <p style="font-size:12px;"><strong style="font-size:14px">Description:</strong> <span style=" font-size:12px;"><?= @$data->description; ?></span></p>
  </div>
  ...
  <p class="b-black border" style="font-size:12px;"><?= @$data->europe_shipment; ?></p>
