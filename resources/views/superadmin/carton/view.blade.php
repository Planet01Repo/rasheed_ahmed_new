            ...
            <div class="span12">
              <div class="grid simple ">
                ...
                <div class="grid-title">
                  ...
                  <a style="float: right;" class="btn btn-success btn-cons" href="{{route('carton.add')}}">Add</a>
                ...
                <div class="grid-body ">
                  <table class="table" id="example3" >
                    ...
                    @php ($count = 1)
                      ...
                      <tr class="">
                        <td>{{ $count++ }}</td>
                        <td>{{ $v->length }} x {{ $v->width }} x {{ $v->height }}</td>
                        <td>{{ $v->length }}</td>
                        <td>{{ $v->width }}</td>
                        <td>{{ $v->height }}</td>
                        <td>
                          <a href="{{route('carton.add')}}/{{$v['id']}}" class="btn-warning btn btn-sm" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
